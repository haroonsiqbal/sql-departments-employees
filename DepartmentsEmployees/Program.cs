...
namespace DepartmentsEmployees
{
    class Program
    {
        ...
        {
            // We must create an instance of the Repository class in order to use its methods to
        ...
        public static void PrintDepartmentReport(string title, List<Department> departments)
        {
            ...
            {
                Console.WriteLine($"{i++}. {item.DeptName}");
            };
        }
        ...
        public static void PrintEmployeeReport(string title, List<Employee> employees)
        {
            ...
            else if (title == "All Employees with departments")
            {
                Console.WriteLine(title);
                foreach (Employee item in employees)
                    if (item.Department.DeptName != null)
                {
                    Console.WriteLine($"{i++}. {item.FirstName} {item.LastName}. Department: {item.Department.DeptName}");
                } else
                    {
                    Console.WriteLine($"{i++}. {item.FirstName} {item.LastName}");
                    }
            ...
            else
            {
                ...
                foreach (Employee item in employees)
                {
                    Console.WriteLine($"{i++}. {item.FirstName} {item.LastName}. Id: {item.Id}. Department: {item.Department.DeptName}");
                };
            }
